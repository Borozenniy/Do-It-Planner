...
//);
// http://localhost:5173
app.use(express_1.default.json()); // Для парсингу JSON тіла запиту
//app.options('*', cors());
//* MongoDB Connection
mongoose
...
app.post('/uploadSuccessful', urlencodedParser, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      yield sql`INSERT INTO Users (Id, Name, Email) VALUES (${req.body.user_id}, ${req.body.name}, ${req.body.email});`;
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (users && users.rows.length > 0) {
        ...
        res.status(404).send('Users not foundddd');
      }
    } catch (error) {
      console.error(error);
